  ...
  >
      ...
      <div class="mt-6 flex justify-between items-center">
          <div class="flex justify-center items-center">
              <p class="tracking-tight text-5xl font-semibold leading-12 text-slate-950">
                  {{ item.short_name }}
              </p>
          </div>
          <div class="flex justify-center items-center">
      ...
      <div v-if="item.show" :id="'menu' + index" class="flex flex-col justify-start items-start mt-12">
          ...
          <div class="flex justify-between flex-col lg:flex-row items-center mt-10 w-full space-y-4 lg:space-y-0 lg:space-x-4 xl:space-x-8">
              <div class="w-full">
                  ...
                  >
                      <button class="focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-gray-800 w-full tracking-tight py-4 text-lg leading-4 hover:bg-gray-300 hover:text-gray-800 bg-white border border-gray-800">
                          Más info
                      </button>
                  </router-link>
              </div>
      ...
      async fetchProducts() {
          try {
              ...
              this.products = paginator.results.map((product, index) => ({
                  ...product,
                  show: index === 0 ? true : this.isMobileOrTablet,
