<template>
  <div class="container mx-auto px-4 flex flex-col items-center min-h-screen mb-10">
    ...
    <div class="border-t w-full mb-5 flex">
      ...
      <div class="description-order w-3/4 mt-5 border p-5" ref="descriptionOrderUser">
...
import ItemListOrder from "@/components/Order/ItemListOrderUser.vue";
...
export default {
  ...
  methods: {
    ...
    handleSelectedOrder(order) {      
      ...
      this.$refs.descriptionOrderUser.scrollIntoView({ behavior: 'smooth' });
